...
//		Query query = session.getNamedQuery("Account.find.all");
//		List<Account> accounts=query.list();
//		for (Account account : accounts) {
//			System.out.println(account);
//		}
		
//		Query query = session.getNamedQuery("Account.find.byId");
//		query.setParameter("acNumber", 102);
//		List<Account> accounts = query.list();
//		for (Account account : accounts) {
//			System.out.println(account);
//		}
		
//		Query query = session.getNamedQuery("Account.find.byName");
...
//		Query query = session.getNamedQuery("Account.find.byBalance");
...
//		}
		...
		Query query = session.getNamedQuery("Account.delete.byNo");
		query.setParameter("acNumber", 104);
